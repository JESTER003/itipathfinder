...
const Card1 = (props) => {
    return (
        <div className="bg-white border-t-[12px] border-[${props.borderColor}] w-fit shadow-2xl ">
            <div className="border-t-[2px] border-white">
                <img src={props.img} alt="" width={300} height={200}/>
            </div>
            <div className="p-3 ">
                <div className="flex items-center justify-start">
                    <h3 className='uppercase text-xl font-semibold '>{props.title} <span className='text-[15px] border border-gray-800 p-1 rounded '>{props.cn} Colleges</span></h3>
                </div>
                <div className="mt-3">
                    <ul>
